        ...
        <form name="cForm" id="cForm" class="contact-form" method="post" action="#form">
            <fieldset>
                ...
                <div class="form-field">
                    <input name="email" id="cEmail" class="full-width" placeholder="Votre adresse e-mail*" value="<?= $this->esc($form->formBuilder()->getField('email')->getValue()); ?>" type="email">
                ...
                <div class="form-field">
                    <input name="subject" id="cEmail" class="full-width" placeholder="Objet*" value="<?= $this->esc($form->formBuilder()->getField('subject')->getValue()); ?>" type="text">
                    <?php if($form->formBuilder()->getField('subject')->getError() !== null && $form->isSubmited()) { ?>
                        <div class="error"><?= $this->esc($form->formBuilder()->getField('subject')->getError()); ?></div>
                    <?php } ?>
                </div>

                <div class="message form-field">
                    <textarea name="message" id="cMessage" class="full-width" placeholder="Votre message*"><?= $this->esc($form->formBuilder()->getField('message')->getValue()); ?></textarea>
                    <?php if($form->formBuilder()->getField('message')->getError() !== null && $form->isSubmited()) { ?>
                        <div class="error"><?= $this->esc($form->formBuilder()->getField('message')->getError()); ?></div>
                    <?php } ?>
                </div>
                ...
                <div class="message form-field form-privacy-consent">
                    ...
                    <?php if($form->formBuilder()->getField('privacy_consent_date')->getError() !== null && $form->isSubmited()) { ?>
                        <div class="error"><?= $this->esc($form->formBuilder()->getField('privacy_consent_date')->getError()); ?></div>
                    <?php } ?>
                </div>
