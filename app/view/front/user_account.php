        ...
        <div class="col-full s-content__main">
            ...
            <form name="cForm" id="cForm" class="contact-form" method="post" action="">
                <fieldset>
                    ...
                    <div>
                        <input name="password" id="cpassword" class="full-width" placeholder="Choisissez un mot de passe*" value="<?= esc($form->formBuilder()->getField('password')->getValue()); ?>" type="password" maxlength="<?= esc($form->formBuilder()->getField('password')->getMaxLength()); ?>" required>
                    </div>
