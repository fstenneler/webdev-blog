<section class="s-content s-content--top-padding s-content--narrow">
    ...
    <div class="row">
        <div class="col-full s-content__main">
            ...
            <div class='existing-account'>Déjà inscrit ? <a href="<?= htmlspecialchars($this->app()->route()->setUrl(array('page' => 'user', 'action' => 'login'))); ?>">Cliquez ici</a> pour vous identifier</div>
