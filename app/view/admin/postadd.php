        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <form class="user" method="post" action="" enctype="multipart/form-data">
                <input type="hidden" name="MAX_FILE_SIZE" value="<?= htmlspecialchars(MAX_FILE_SIZE); ?>" />
                    <div class="form-group row">
                        <div class="col-xl-4">
                            ...
                            <select name='category_id' class="form-control form-control-user" id="articleCategory" placeholder="Catégorie">
                                ...
                                <option value="<?= htmlspecialchars($category->id); ?>"<?php if($form->formBuilder()->getField('category_id')->getValue() == $category->id) { echo " selected"; } ?>><?= htmlspecialchars($category->name); ?></option>
                                <?php } ?>
                            </select>
                            <?php if($form->formBuilder()->getField('category_id')->getError() !== null && $form->isSubmited()) { ?>
                                <div class="form-control-error"><?= htmlspecialchars($form->formBuilder()->getField('category_id')->getError()); ?></div>
                            <?php } ?>
                        </div>
                        <div class="col-xl-3">
                            ...
                            <select name='user_id' class="form-control form-control-user" id="articleUser" placeholder="Auteur">
                                ...
                                <option value="<?= htmlspecialchars($user->id); ?>"<?php if( $form->formBuilder()->getField('user_id')->getValue() == $user->id) { echo " selected"; } ?>><?= htmlspecialchars($user->nickname); ?></option>
                                <?php } ?>
                            </select>
                            <?php if($form->formBuilder()->getField('user_id')->getError() !== null && $form->isSubmited()) { ?>
                                <div class="form-control-error"><?= htmlspecialchars($form->formBuilder()->getField('user_id')->getError()); ?></div>
                            <?php } ?>
                        </div>
                        <div class="col-xl-2">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 col-xl-9">
                            ...
                            <?php if($form->formBuilder()->getField('content')->getError() !== null && $form->isSubmited()) { ?>
                                <div class="form-control-error"><?= htmlspecialchars($form->formBuilder()->getField('content')->getError()); ?></div>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-xl-3">
                            ...
                            <?php if($form->formBuilder()->getField('image_main')->getError() !== null && $form->isSubmited()) { ?>
                                <div class="form-control-error"><?= htmlspecialchars($form->formBuilder()->getField('image_main')->getError()); ?></div>
                            <?php } ?>
                        </div>
                        <div class="col-xl-3">
                            ...
                            <?php if($form->formBuilder()->getField('image_medium')->getError() !== null && $form->isSubmited()) { ?>
                                <div class="form-control-error"><?= htmlspecialchars($form->formBuilder()->getField('image_medium')->getError()); ?></div>
                            <?php } ?>
                        </div>
                        <div class="col-xl-3">
                            ...
                            <?php if($form->formBuilder()->getField('image_small')->getValue() !== '') { ?>
                                <img class="form-control-image-thumb" src="<?= htmlspecialchars(GALLERY_DIR . $form->formBuilder()->getField('image_small')->getValue()); ?>" alt="<?= htmlspecialchars(esc($form->formBuilder()->getField('title')->getValue())); ?>" />
                            <?php } ?>
                            ...
                            <?php if($form->formBuilder()->getField('image_small')->getError() !== null && $form->isSubmited()) { ?>
                                <div class="form-control-error"><?= htmlspecialchars($form->formBuilder()->getField('image_small')->getError()); ?></div>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="form-group row">
