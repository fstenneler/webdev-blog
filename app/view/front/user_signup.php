        ...
        <div class="col-full s-content__main">
            ...
            <form name="cForm" id="cForm" class="contact-form" method="post" action="">
                <fieldset>
                    ...
                    <div>
                        <input name="first_name" id="cfirst_name" class="full-width" placeholder="Votre prénom*" value="<?= esc($form->formBuilder()->getField('first_name')->getValue()); ?>" type="text" maxlength="<?= esc($form->formBuilder()->getField('first_name')->getMaxLength()); ?>" required>
                    </div>
                    <?php if($form->formBuilder()->getField('first_name')->getError() !== null && $form->isSubmited()) { ?>
                        <div class="error"><?= esc($form->formBuilder()->getField('first_name')->getError()); ?></div>
                    <?php } ?>

                    <div>
                        <input name="name" id="cname" class="full-width" placeholder="Votre nom*" value="<?= esc($form->formBuilder()->getField('name')->getValue()); ?>" type="text" maxlength="<?= esc($form->formBuilder()->getField('name')->getMaxLength()); ?>" required>
                    </div>
                    ...
                    <div>
                        <input name="email" id="cemail" class="full-width" placeholder="Votre adresse e-mail*" value="<?= esc($form->formBuilder()->getField('email')->getValue()); ?>" type="email" maxlength="<?= esc($form->formBuilder()->getField('email')->getMaxLength()); ?>" required>
                    </div>
                    ...
                    <div>
                        <input name="nickname" id="cnickname" class="full-width" placeholder="Choisissez un pseudo*" value="<?= esc($form->formBuilder()->getField('nickname')->getValue()); ?>" type="text" maxlength="<?= esc($form->formBuilder()->getField('nickname')->getMaxLength()); ?>" required>
                    </div>
                    <?php if($form->formBuilder()->getField('nickname')->getError() !== null && $form->isSubmited()) { ?>
                        <div class="error"><?= esc($form->formBuilder()->getField('nickname')->getError()); ?></div>
                    <?php } ?>

                    <div>
                        <input name="password" id="cpassword" class="full-width" placeholder="Choisissez un mot de passe*" value="<?= esc($form->formBuilder()->getField('password')->getValue()); ?>" type="password" minlength="<?= esc($form->formBuilder()->getField('password')->getMinLength()); ?>" maxlength="<?= esc($form->formBuilder()->getField('password')->getMaxLength()); ?>" required>
                    </div>
                    <?php if($form->formBuilder()->getField('password')->getError() !== null && $form->isSubmited()) { ?>
                        <div class="error"><?= esc($form->formBuilder()->getField('password')->getError()); ?></div>
                    <?php } ?>
                    ...
                    <input type="hidden" id="cAvatarColor" name="avatar" value="<?= esc($form->formBuilder()->getField('avatar')->getValue()); ?>">

                    <?php if($form->formBuilder()->getField('avatar')->getError() !== null && $form->isSubmited()) { ?>
                        <div class="error"><?= esc($form->formBuilder()->getField('avatar')->getError()); ?></div>
                    <?php } ?>
            ...
            <div class='existing-account'>Déjà inscrit ? <a href="<?= esc($this->app()->route()->setUrl(array('page' => 'user', 'action' => 'login'))); ?>">Cliquez ici</a> pour vous identifier</div>
