        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Utilisateur : FabienS</h6>
            </div>
            <div class="card-body">
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                        <div class="col-sm-12 col-lg-4">
                            ...
                            <input type="text" class="form-control form-control-user" id="userNickname" placeholder="Pseudo" value="FabienS">
                        </div>
                        <div class="col-sm-12 col-lg-4">
                            <label for="userNickname">E-mail</label>
                            <input type="text" class="form-control form-control-user" id="userNickname" placeholder="E-mail" value="fabien.stenneler@gmail.com">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-12 col-lg-4">
                            <label for="userFirstname">Prénom</label>
                            <input type="text" class="form-control form-control-user" id="userFirstname" placeholder="Prénom" value="Fabien">
                        </div>
                        <div class="col-sm-12 col-lg-4">
                            <label for="userName">Nom</label>
                            <input type="text" class="form-control form-control-user" id="userName" placeholder="Nom" value="Stenneler">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-12 col-lg-8">
                            ...
                            <ul class="form-color-picker">
                              ...
                              <li data-color="#7D3C98" class="border" style="background-color: #7D3C98;"></li>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 col-lg-9">
                            ...
                            <textarea class="form-control form-control-user" id="userDescription" placeholder="Description" style="height: 15em;">Alias aperiam at debitis deserunt dignissimos dolorem doloribus, fuga fugiat impedit laudantium magni maxime nihil nisi quidem quisquam sed ullam voluptas voluptatum. Lorem ipsum dolor sit.</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-12 col-lg-9">
