                ...
                <div class="featured-slider featured" data-aos="zoom-in">
                    ...
                    <div class="featured__slide">
                        <div class="entry">
                            ...
                            <div class="entry__background" style="background-image:url('public/frontend/images/gallery/<?= htmlspecialchars($post->image_main); ?>');"></div>
                    ...
                    <div class="item-entry" data-aos="zoom-in">
                        <div class="item-entry__thumb">
                            <a href="<?= htmlspecialchars($post->url); ?>" class="item-entry__thumb-link">
                                <img src="public/frontend/images/gallery/<?= htmlspecialchars($post->image_medium); ?>" alt="">
                            </a>
                        </div>
            ...
            <div class="col-full">
                <nav class="pgn" data-aos="fade-up">
                    ...
                    <ul>
                        ...
                        <li><a class="pgn__num <?php if($page == $pagination['currentPage']) { echo 'current'; } ?>" href="<?= $url; ?>"><?= $page; ?></a></li>
                        <?php } ?>
