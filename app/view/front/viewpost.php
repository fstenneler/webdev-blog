        ...
        <article class="row entry format-standard">
            ...
            <div class="entry__media col-full">
                <div class="entry__post-thumb">
                    <img src="<?= esc(GALLERY_DIR . $this->app()->getData('post')->image_main); ?>" alt="<?= esc($this->app()->getData('post')->title); ?>">
                </div>
            </div>

            <div class="entry__header col-full">
                <h1 class="entry__header-title display-1">
                <?= esc($this->app()->getData('post')->title); ?>
                </h1>
                <ul class="entry__header-meta">
                    <li class="date"><?= esc($this->app()->getData('post')->creation_date); ?></li>
                    <li class="byline">par <?= esc($this->app()->getData('post')->user_nickname); ?></li>
                    <?php if($this->app()->getData('post')->last_modification_date !== null && $this->app()->getData('post')->last_modification_date !== $this->app()->getData('post')->creation_date) { ?>
                        <li class="date">modifié le <?= esc($this->app()->getData('post')->last_modification_date); ?></li>
                    <?php } ?>
                </ul>
            </div>
            ...
            <div class="col-full entry__main">
                ...
                <?= esc($this->app()->getData('post')->content); ?>

                <div class="entry__taxonomies">
                    <div class="entry__cat">
                        <h5>Posted In: </h5>
                        <span class="entry__tax-list">
                            <a href="<?= esc($this->app()->getData('post')->category_url); ?>"><?= esc($this->app()->getData('post')->category_name); ?></a>
                        </span>
                    </div> <!-- end entry__cat -->
                </div> <!-- end s-content__taxonomies -->

                <div class="entry__author">
                    <div class="entry__author-icon"><?= esc($this->app()->getData('post')->avatar_icon); ?></div>

                    <div class="entry__author-about">
                        <h5 class="entry__author-name">
                            <span>Posté par</span>
                            <?= esc($this->app()->getData('post')->user_nickname); ?>
                        </h5>
        ...
        <div class="comments-wrap">
            ...
            <div id="comments" class="row">
                <div class="col-full">
                    ...
                    <h3 class="h2"><?= esc($this->app()->getData('CommentNumberText')); ?></h3>
                    <a name='#comments'></a>
                        ...
                        <?php foreach($commentList[0] as $commentLevel1) { ?>
                            ...
                            <li class="thread-alt depth-1 comment">
                                ...
                                <div class="comment__avatar">
                                    <?= esc($commentLevel1->user_avatar_icon); ?>
                                </div>

                                <div class="comment__content">

                                    <div class="comment__info">
                                        <div class="comment__author"><?= esc($commentLevel1->user_nickname); ?></div>

                                        <div class="comment__meta">
                                            <div class="comment__time"><?= esc($commentLevel1->date); ?></div>
                                            <?php if(!isset($commentList[$commentLevel1->id])) { ?>
                                            <div class="comment__reply">
                                                <span class="comment-reply-link" data-comment-id="<?= esc($commentLevel1->id); ?>">Répondre</span>
                                            </div>
                                            <?php } ?>
                                        </div>
                                    </div>
                                ...
                                <ul class="children">
                                    ...
                                    <li class="depth-2 comment">
                                        ...
                                        <div class="comment__avatar">
                                            <?= esc($commentLevel2->user_avatar_icon); ?>
                                        </div>

                                        <div class="comment__content">

                                            <div class="comment__info">
                                                <div class="comment__author"><?= esc($commentLevel2->user_nickname); ?></div>

                                                <div class="comment__meta">
                                                    <div class="comment__time"><?= esc($commentLevel2->date); ?></div>
                                    ...
                                    <li class="comment-reply-form" id="comment-reply-form-<?= esc($commentLevel1->id); ?>">
                                        <div class="comment__content">
                                            <div class="comment__info">
                                            ...
                                            <form name="contactForm" method="post" action="#comments" autocomplete="off">
                                                <fieldset>
                                                    ...
                                                    <input name="parent_comment_id" value="<?= esc($commentLevel1->id); ?>" type="hidden">
                                                    <input name="submit" class="btn btn--primary btn-wide btn--large full-width" value="Répondre" type="submit">

                                                </fieldset>
                                            </form>
                                            <?php } else { ?>
                                                <div class="message-comment-connected-reply">Vous devez être <a href="<?= esc($this->app()->route()->setUrl(array('page' => 'user', 'action' => 'login'))); ?>">connecté</a> pour répondre.</div>
                                            <?php } ?>
                                        </div>
                                    </li>
                    ...
                    <?php if($this->app()->getData('formError')) { ?>
                        <div class='form-error'>
                            <?= esc($this->app()->getData('formError')); ?>
                        </div>
                    <?php } ?>
            ...
            <div class="row comment-respond">
                ...
                <div id="respond" class="col-full">
                    ...
                    <?php } else { ?>
                        <div class="message-comment-connected">Vous devez être <a href="<?= esc($this->app()->route()->setUrl(array('page' => 'user', 'action' => 'login'))); ?>">connecté</a> pour laisser un commentaire.</div>
                    <?php } ?>
                </div>
