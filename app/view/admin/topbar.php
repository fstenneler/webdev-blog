...
<ul class="navbar-nav ml-auto">
  ...
  <li class="nav-item dropdown no-arrow mx-1">
    <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      ...
      <!-- Counter - Alerts -->
      <span class="badge badge-danger badge-counter"><?= htmlspecialchars($this->app()->getData('CommentNumber')); ?></span>
    </a>
    <!-- Dropdown - Alerts -->
    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
      ...
      <a class="dropdown-item d-flex align-items-center" href="index.php?page=comment&action=view&postId=<?= htmlspecialchars($comment->post_id); ?>">
        ...
        <div>
          <div class="small text-gray-500"><?= htmlspecialchars($comment->date); ?></div>
  ...
  <li class="nav-item dropdown no-arrow mx-1">
    <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      ...
      <!-- Counter - Messages -->
      <span class="badge badge-danger badge-counter"><?= htmlspecialchars(count($this->app()->getData('contactList'))); ?></span>
    </a>
    <!-- Dropdown - Messages -->
    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
      ...
      <a class="dropdown-item d-flex align-items-center" href="index.php?page=contact&action=view&contactId=<?= htmlspecialchars($contact->id); ?>">
        <div class="font-weight-bold">
          <div class="text-truncate"><?= htmlspecialchars($contact->subject); ?></div>
          <div class="small text-gray-500"><?= htmlspecialchars($contact->name); ?> · <?= htmlspecialchars($contact->date); ?></div>
        </div>
      </a>
