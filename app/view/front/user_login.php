        ...
        <div class="col-full s-content__main">
            ...
            <form name="cForm" id="cForm" class="contact-form" method="post" action="">
                <fieldset>
                    ...
                    <div>
                        <input name="cEmail" id="cEmail" class="full-width" placeholder="Your Email*" value="<?= esc($this->app()->getData('email')); ?>" type="email">
                    </div>
            ...
            <div class='existing-account'>Pas encore inscrit ? <a href="<?= esc($this->app()->route()->setUrl(array('page' => 'user', 'action' => 'signup'))); ?>">Cliquez ici</a> pour créer un nouveau compte</div>
