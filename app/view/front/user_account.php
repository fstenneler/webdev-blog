            ...
            <form name="cForm" id="cForm" class="contact-form" method="post" action="">
                <fieldset>
                    ...
                    <?php if($form->formBuilder()->getField('first_name')->getError() !== null && $form->isSubmited()) { ?>
                        <div class="error"><?= htmlspecialchars($form->formBuilder()->getField('first_name')->getError()); ?></div>
                    <?php } ?>
                    ...
                    <?php if($form->formBuilder()->getField('nickname')->getError() !== null && $form->isSubmited()) { ?>
                        <div class="error"><?= htmlspecialchars($form->formBuilder()->getField('nickname')->getError()); ?></div>
                    <?php } ?>

                    <div>
                        <input name="password" id="cpassword" class="full-width" placeholder="Choisissez un mot de passe*" value="<?= htmlspecialchars($form->formBuilder()->getField('password')->getValue()); ?>" type="password" maxlength="<?= htmlspecialchars($form->formBuilder()->getField('password')->getMaxLength()); ?>" required>
                    </div>
                    <?php if($form->formBuilder()->getField('password')->getError() !== null && $form->isSubmited()) { ?>
                        <div class="error"><?= htmlspecialchars($form->formBuilder()->getField('password')->getError()); ?></div>
                    <?php } ?>
                    ...
                    <input type="hidden" id="cAvatarColor" name="avatar" value="<?= htmlspecialchars($form->formBuilder()->getField('avatar')->getValue()); ?>">

                    <?php if($form->formBuilder()->getField('avatar')->getError() !== null && $form->isSubmited()) { ?>
                        <div class="error"><?= htmlspecialchars($form->formBuilder()->getField('avatar')->getError()); ?></div>
                    <?php } ?>
