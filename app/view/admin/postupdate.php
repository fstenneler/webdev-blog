                ...
                <form class="user" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 col-xl-9">
                            <input id="checkbox-display" type="checkbox"<?php if($form->formBuilder()->getField('display')->getValue() === 1) { ?> checked<?php } ?>> Afficher l'article sur le blog
                    ...
                    <div class="form-group row">
                        <div class="col-xl-4">
                            ...
                            <select name='category_id' class="form-control form-control-user" id="articleCategory" placeholder="Catégorie">
                                ...
                                <option value="<?= $category->id; ?>"<?php if($form->formBuilder()->getField('category_id')->getValue() == $category->id) { ?> selected<?php } ?>><?= $category->name; ?></option>
                                <?php } ?>
                            </select>
                        ...
                        <div class="col-xl-3">
                            ...
                            <select name='user_id' class="form-control form-control-user" id="articleUser" placeholder="Auteur">
                                ...
                                <option value="<?= $user->id; ?>"<?php if( $form->formBuilder()->getField('user_id')->getValue() == $user->id) { ?> selected<?php } ?>><?= $user->nickname; ?></option>
                                <?php } ?>
                            </select>
                        ...
                        <div class="col-xl-2">
                            ...
                            <select name='is_hero' class="form-control form-control-user" id="articleHero" placeholder="Article à la une">
                                <option value="0"<?php if( $form->formBuilder()->getField('is_hero')->getValue() == 0) { ?> selected<?php } ?>>Non</option>
                                <option value="1"<?php if( $form->formBuilder()->getField('is_hero')->getValue() == 1) { ?> selected<?php } ?>>Oui</option>
                            </select>
                        </div>
                    </div>
                   <div class="form-group row">
